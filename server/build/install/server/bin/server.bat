...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.4-M3.jar;%APP_HOME%\lib\pushy-0.14.1.jar;%APP_HOME%\lib\slf4j-simple-1.7.30.jar;%APP_HOME%\lib\slf4j-api-1.7.30.jar;%APP_HOME%\lib\kotlinx-coroutines-jdk8-1.3.8.jar;%APP_HOME%\lib\kotlinx-coroutines-core-1.3.8.jar;%APP_HOME%\lib\kotlin-script-runtime-1.4-M3.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.4-M3.jar;%APP_HOME%\lib\kotlin-stdlib-1.4-M3.jar;%APP_HOME%\lib\netty-codec-http2-4.1.48.Final.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.48.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.48.Final.jar;%APP_HOME%\lib\fast-uuid-0.1.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.4-M3.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\netty-codec-http-4.1.48.Final.jar;%APP_HOME%\lib\netty-handler-4.1.48.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.48.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.48.Final.jar;%APP_HOME%\lib\netty-codec-4.1.48.Final.jar;%APP_HOME%\lib\netty-transport-4.1.48.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.48.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.48.Final.jar;%APP_HOME%\lib\netty-common-4.1.48.Final.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ApplicationKt %CMD_LINE_ARGS%
